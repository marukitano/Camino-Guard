...
final class WalkingPerformanceStore
    ...
    /*
     * Process-local change counter. The Activity-side prediction model reloads
     * history only after the foreground service has persisted a new minute.
     */
    private static final AtomicLong DATA_GENERATION =
            new AtomicLong();
    ...
    void insert(
        ...
        DATA_GENERATION.incrementAndGet();
    }
