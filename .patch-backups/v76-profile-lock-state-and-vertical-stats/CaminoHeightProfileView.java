...
final class CaminoHeightProfileView extends View {
    ...
    CaminoHeightProfileView(
        ...
        /*
         * Match the filled elevation-profile body to the selected-route stats
         * overlay. Only the fill changes; profile contour, slope colours,
         * cursor and markers keep their existing styling.
         */
        fillPaint.setColor(
                Color.argb(
                        150,
