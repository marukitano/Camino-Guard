...
final class CaminoHeightProfileView extends View {
    ...
    private int slopeLineColor(
        ...
        /*
         * Unlocked: preserve the original warm-white neutral profile.
         *
         * Locked: the neutral line becomes the same dark RGB family as the
         * locked fill. Uphill/downhill interpolation still runs toward the
         * existing red/green targets, so the grade information remains fully
         * visible instead of becoming one uniformly dark line.
         */
        final int neutralR =
                lockedProfileStyle
                        ? 24
