...
final class CaminoHeightProfileView extends View {
    ...
    private static final float TOGGLE_TOP_MARGIN_DP = 8.0f;
    ...
    private RectF toggleRect() {
        ...
        /*
         * v82: profile toggle belongs in the top-right corner instead of the
         * vertical screen centre.
         */
        float top =
                dp(
                        TOGGLE_TOP_MARGIN_DP
                );
