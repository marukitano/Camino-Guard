...
final class CaminoSelectionStatsOverlay {
    ...
    void ensureView() {
        ...
        /*
         * Intentionally physical pixels: the vertical stats text should sit
         * almost flush with the display edge.
         */
        params.rightMargin =
                3;
     ...
     */
    /*
     * Narrow vertical stats strip at the physical right screen edge.
     * Text is drawn directly instead of relying on rotated TextView layout.
     */
