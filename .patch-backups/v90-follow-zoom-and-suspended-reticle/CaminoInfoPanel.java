...
final class CaminoInfoPanel extends FrameLayout {
    ...
    private final TextView zoomLevelView;
    ...
    CaminoInfoPanel(Context context) {
        ...
        /*
         * Temporary-but-permanent-on-screen zoom readout for tuning the two
         * follow modes. It updates on every camera move.
         */
        zoomLevelView =
                new TextView(
                        context
        ...
        zoomLevelView.setText(
                "z --"
        );

        zoomLevelView.setTextColor(
                Color.rgb(
                        35,
                        39,
                        43
        ...
        zoomLevelView.setTextSize(
                10.5f
        );

        zoomLevelView.setTypeface(
                Typeface.MONOSPACE,
                Typeface.BOLD
        );

        zoomLevelView.setGravity(
                Gravity.CENTER
        );

        GradientDrawable zoomBackground =
                new GradientDrawable();

        zoomBackground.setShape(
                GradientDrawable.RECTANGLE
        );

        zoomBackground.setColor(
                Color.argb(
                        215,
                        255,
                        255,
        ...
        zoomBackground.setCornerRadius(
                dp(
                        5.0f
                )
        );

        zoomBackground.setStroke(
                dpInt(
                        1
                ),
                Color.argb(
