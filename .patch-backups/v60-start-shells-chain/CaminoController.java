...
public final class CaminoController {
    ...
    private boolean handleStagePlaceTap(
        ...
        if (selectedStageSelection != null
                ...
                && !stagePathResolver.isDecisionShell(
                placeKey,
                stagePoint
        )) {
            ...
            if (extensionChoices.size() == 1) {
                ...
                if (nextStage.route
                    ...
                    if (selectedStageSelection.resolvedPath != null
                            && nextStage.resolvedPath != null) {

                        CaminoResolvedStagePath combined =
                                stagePathResolver.append(
                                        selectedStageSelection.resolvedPath,
                                        nextStage.resolvedPath
                                );
                        ...
                        if (combined != null) {
                            selectedStageSelection =
                                    new StageRouteSelection(
                                            ...
                                            combined.startHit,
                                            combined.endHit,
                                            selectedStageSelection.primaryTrackIndex,
                                            null,
                                            true,
                                            null,
                                            null,
