...
final class CaminoHeightProfileView extends View {
    ...
    private void drawCursor(
        ...
        /*
         * reuse exact locked marker v78
         *
         * Finger altitude display deliberately uses the very same drawing
         * routine as the permanent locked-position marker:
         *   - same blue outer/inner dot on the profile contour
         *   - same metre label beside the contour
         *   - same edge-aware left/right placement
         */
        drawLockedPositionMarker(
                canvas,
                sample,
